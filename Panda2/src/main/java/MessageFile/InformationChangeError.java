...
public class InformationChangeError  extends JFrame implements ActionListener{
	...
	public void createGUI(int index){
		...
		frame= new JFrame();
		switch(index) {
		case 1: lbl = new JLabel("Invalid phone number", JLabel.CENTER);
				break;
		case 2: lbl = new JLabel("Invalid Email (Baylor email only)", JLabel.CENTER);
				break;
		case 3: lbl = new JLabel("Invaild Driver License", JLabel.CENTER);
				break;
		default: 
